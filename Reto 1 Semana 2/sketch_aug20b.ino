...
const char ssid[] = "iPhone William";
//Contraseña de la red Wifi
const char pass[] = "1020304050";

//Usuario uniandes sin @uniandes.edu.co
#define HOSTNAME "wr.ravelo"

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "wr.ravelo";
//Contraseña de MQTT que recibió por correo
const char MQTT_PASS[] = "201532093";
...
// Topico al que se enviaran los datos de luminosidad
...
{  
  ...
  if ( !isnan(h) && !isnan(t) ) {
    ...
    //Publica en el topico de luminosidad
